...
const routeHelper = (name, params = null, absolute = false) => {
    ...
    const routes = {
        ...
        'settings.google-contacts.sync-stop': '/settings/google-contacts/sync-stop',
        'settings.google-contacts.sync-progress': '/settings/google-contacts/sync-progress',
        'settings.google-contacts.import-start': '/settings/google-contacts/import-start',
        'settings.google-contacts.import-progress': '/settings/google-contacts/import-progress',
        'settings.google-contacts.photo-sync-start': '/settings/google-contacts/photo-sync-start',
        'settings.google-contacts.photo-sync-progress': '/settings/google-contacts/photo-sync-progress',
        'settings.google-contacts.photo-sync-stop': '/settings/google-contacts/photo-sync-stop',
