                ...
                <div class="flex items-center space-x-6">
                    <div class="flex-shrink-0">
                        <img
                            ...
                            :src="avatarPreview || `/storage/${customer.avatar}`"
                            alt="Avatar Preview"
...
const form = useForm({
    ...
    type: props.customer.type || 'person',
    gender: props.customer.gender || null,
    languages: initialLanguages(props.customer),
    avatar: null,
    ...
    contacts: props.customer.contacts ? props.customer.contacts.map(c => ({
        id: c.id,
        type: c.type,
        value: c.value,
        is_primary: c.is_primary || false,
    })) : [],
    social_media: props.customer.social_media ? props.customer.social_media.map(sm => ({
        id: sm.id,
        social_media_type_id: sm.social_media_type_id,
        handle: sm.handle,
        is_primary: sm.is_primary || false,
    })) : [],
});
