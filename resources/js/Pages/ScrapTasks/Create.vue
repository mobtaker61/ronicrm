            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-6">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-xs text-gray-500">— یک آدرس، استخراج المان‌های تکراری (مثلاً لیست لینک‌ها یا عنوان‌ها)</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <template v-if="form.type === 'list'">
                    ...
                    <div class="border-t pt-6">
                        ...
                        <p class="text-xs text-gray-500 mb-2">XPath یا class یا id که به چند المان اشاره می‌کند. از هر المان یک مقدار (متن یا attribute) استخراج می‌شود.</p>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        هر URL در یک خط. می‌توانید لیست را کپی کنید یا از فایل متنی/CSV ایمپورت کنید.
                    </p>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="text-xs text-gray-500 mb-3">
                        برای هر فیلدی که می‌خواهید از صفحه استخراج شود، یک پارامتر با نام، نوع سلکتور (xpath / class / id) و مقدار آن تعریف کنید.
                    </p>
                    <div class="space-y-4">
                        <div
                        ...
                        >
                            <input
                                v-model="param.name"
                                type="text"
                                placeholder="نام فیلد (مثلاً عنوان)"
...
async function pasteUrls() {
    try {
        ...
        alert('دسترسی به کلیپبورد ممکن نیست. می‌توانید با Ctrl+V مستقیم در کادر متن بچسبانید.');
    }
}
...
function submit() {
    ...
    const urls = lines.filter(line => /^https?:\/\//i.test(line));
    if (urls.length < 1) {
        alert('حداقل یک آدرس معتبر (شروع با http یا https) در هر خط وارد کنید.');
        return;
    }
