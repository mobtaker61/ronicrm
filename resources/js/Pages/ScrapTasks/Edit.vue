<template>
    <AppLayout>
        <template #header>
            {{ t('scrap_tasks.edit_scraping_task') }}
        </template>
            ...
            <form @submit.prevent="submit" class="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-6">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-xs text-gray-500">{{ t('scrap_tasks.list_extraction_help_short') }}</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                ...
                <template v-if="form.type === 'list'">
                    ...
                    <div class="border-t pt-6">
                        ...
                        <p class="text-xs text-gray-500 mb-2">{{ t('scrap_tasks.repeating_selector_help_short') }}</p>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        {{ t('scrap_tasks.url_text_help_edit') }}
                    </p>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="text-xs text-gray-500 mb-3">
                        {{ t('scrap_tasks.extraction_fields_help_short') }}
                    </p>
                    <div class="space-y-4">
                        <div
                        ...
                        >
                            <input
                                v-model="param.name"
                                type="text"
                                :placeholder="t('scrap_tasks.field_name_placeholder_short')"
...
async function pasteUrls() {
    try {
        ...
        alert(t('scrap_tasks.clipboard_access_not_available_short'));
    }
}
...
function submit() {
    ...
    const urls = lines.filter(line => /^https?:\/\//i.test(line));
    if (urls.length < 1) {
        alert(t('scrap_tasks.enter_at_least_one_valid_url_edit'));
        return;
    }
