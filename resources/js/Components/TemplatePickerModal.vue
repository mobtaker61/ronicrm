    ...
    <div v-if="show" class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" @click.self="$emit('close')">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[85vh] flex flex-col overflow-hidden">
            <div class="flex items-center justify-between p-4 border-b flex-shrink-0">
                <h3 class="text-lg font-semibold text-gray-900">انتخاب تمپلت</h3>
            ...
            <div class="flex-1 flex min-h-0 overflow-hidden">
                ...
                <div class="w-[40%] border-r border-gray-200 overflow-y-auto flex-shrink-0">
                    <div class="p-2">
                        <div
                            ...
                            :class="[
                                'px-4 py-3 rounded-lg cursor-pointer transition-colors text-right',
                        ...
                        <p v-if="templates.length === 0" class="text-center text-gray-500 py-8">تمپلتی یافت نشد.</p>
                    </div>
                </div>
                ...
                <div class="flex-1 flex flex-col min-w-0 p-6">
                    <div v-if="selectedTemplate" class="flex-1 overflow-y-auto">
                        <h4 class="text-sm font-semibold text-gray-700 mb-3">پیش‌نمایش</h4>
                        <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 min-h-[120px]">
                            ...
                            ></div>
                            <p v-else class="text-gray-500 italic">فقط تصویر</p>
                        </div>
                    </div>
                    <div v-else class="flex-1 flex items-center justify-center text-gray-500">
                        <p>یک تمپلت از لیست انتخاب کنید</p>
                    </div>
